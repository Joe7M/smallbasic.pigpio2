...
'
' To run type:
' sbasic -m /usr/local/lib/smallbasic/ i2c_bmp280.bas
' sbasicg -m/usr/local/lib/smallbasic/ -r i2c_bmp280.bas

import i2c

const BMP280 = i2c.Open(0x76)

' Read chip id. BMP280 has id 0x58
id = i2c.ReadReg(BMP280, 0xD0, 1)
print "Chip ID:", "0x"; hex(id)  

delay(500)

' Get calibration data
cal = i2c.ReadReg(BMP280, 0x88, 24)
...
' Configure sensor
i2c.WriteReg(BMP280, 0xF4, 0b01101111)     ' 011: 4x oversampling temperature; 011: 4x oversampling pressure; 11: normal power mode
i2c.WriteReg(BMP280, 0xF5, 0b01010000)     ' 010: t_standby = 125ms;  100: 5 Samples to reach 75%; 00: 4-wire SPI
